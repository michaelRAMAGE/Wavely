...
export const HomeDrawerNav = () => {
    ...
    return (
        <HomeDrawer.Navigator 
            ...
            edgeWidth={width/2}
            sceneContainerStyle={{backgroundColor: 'black'}} // styles all screens
            ...
            > 
                ...
                <HomeDrawer.Screen name="TranscriptDetailTest" component={TranscriptDetailScreen} options={{drawerLabel: 'TranscriptDetailTest'}}/>
        </HomeDrawer.Navigator>
    );
}
...
change export to return to this solution
*/
const HomeNavigator = () => {  
    ...
    // useLayoutEffect --> the rendering update happening after screen painted
    return ( 
        <HeaderContext.Provider value={{setHeader: setHead, headerSets: headerSets}}> 
            <HomeStack.Navigator
                headerMode='screen'
                screenOptions={{
                    header: () => { console.log(head); return (<MainHeader />); },
                }}
            >
                <HomeStack.Screen 
                    // name='Wavely' 
